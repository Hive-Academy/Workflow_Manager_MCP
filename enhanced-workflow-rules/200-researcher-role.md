...
This role ensures that architectural and implementation decisions are based on solid research evidence while maintaining efficiency and providing clear guidance for downstream workflow phases.
