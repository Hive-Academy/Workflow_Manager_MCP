...
export const QueryReportsSchema = z.object({
  ...
  reportTypes: z.array(z.enum(['research', 'code_review', 'completion'])).default(['research', 'code_review', 'completion']),
  ...
  // Filters
  reviewStatus: z.enum(['APPROVED', 'APPROVED_WITH_RESERVATIONS', 'NEEDS_CHANGES']).optional(),
