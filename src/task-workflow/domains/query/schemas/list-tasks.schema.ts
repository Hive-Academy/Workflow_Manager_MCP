...
export const ListTasksSchema = z.object({
  ...
  completedAfter: z
    .date()
    .optional()
    .describe('Tasks completed after this date'),
  completedBefore: z
    .date()
    .optional()
    .describe('Tasks completed before this date'),
  ...
  take: z
    ...
    .max(100)
    .optional()
    .describe('Number of tasks to take (max 100)'),

  // Sorting
  orderBy: z
    .enum(['creationDate', 'completionDate', 'name', 'status', 'priority'])
    .optional()
...
export const ListTasksResponseSchema = z.object({
  ...
  totalCount: z
    .number()
    .int()
    .describe('Total number of tasks matching filters'),
