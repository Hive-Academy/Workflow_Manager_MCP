...
export class TemplateFactoryService {
  ...
  getTemplatePath(reportType: ReportType): string {
    const templateMap: Record<ReportType, string> = {
      ...
      task_summary: 'task-summary.ejs',
      delegation_analytics: 'delegation-analytics.ejs',
      performance_dashboard: 'performance-dashboard.ejs',
      comprehensive: 'comprehensive.ejs',

      // Specialized Insights
      implementation_plan_analytics: 'implementation-plan-analytics.ejs',
      code_review_insights: 'code-review-insights.ejs',
      delegation_flow_analysis: 'delegation-flow-analysis.ejs',

      // Individual Task Reports (B005)
      task_progress_health: 'individual/task-progress-health.ejs',
      implementation_execution: 'individual/implementation-execution.ejs',
      code_review_quality: 'individual/code-review-quality.ejs',
      delegation_flow_analysis_task:
        'individual/delegation-flow-analysis-task.ejs',
      research_documentation: 'individual/research-documentation.ejs',
      communication_collaboration: 'individual/communication-collaboration.ejs',
    };

    return templateMap[reportType] || 'default.ejs';
  }
