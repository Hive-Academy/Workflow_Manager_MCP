...
import { UpdateTaskDescriptionInputType } from '../schemas/update-task-description.schema';
import { TaskDescription, Prisma, Task } from '@prisma/client';
...
describe('TaskDescriptionService', () => {
  ...
  describe('updateTaskDescription', () => {
    ...
    const input: UpdateTaskDescriptionInputType = {
      taskId,
